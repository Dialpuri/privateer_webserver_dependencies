...
namespace clipper {
  ...
  class GEMMIFile : public GemmiStructure
  {
    public:
      //! read structure from file
      void read_file( const String& file );
      //! write structure to file
      void write_file( const String& file, gemmi::CGCoorFormat type, const FileOptions& write_options );
